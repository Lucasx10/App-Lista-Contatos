...
import 'package:app_lista_contatos/pages/home_page.dart';
...
class _AddEditPageState extends State<AddEditPage> {
  ...
  ContatoModel contatoLocal = ContatoModel(
    nome: '',
    telefone: '',
    foto: '',
  );
  ...
  void _addContato() async {
    ...
    final added = await ContatoRepository().addContato(contatoLocal);
  ...
  void _editContato() async {
    ...
    final edited = await ContatoRepository().updateContato(contatoLocal);
    setState(() {
      loading = false;
    });
